...
class Invoice extends FPDF
{
	...
	function Head($data)
	{
		...
		// LOGO
		$this->Image(str_replace('-', '', $data['company_data']['ident'].'.png'), 10, 8);
...
//		$this->SetFont('UniFont', '', 12);
		...
		// IIBB
		$this->SetX(114);
		$this->Cell(36, 3, "Ingresos Brutos: " . ' ' . mb_strtoupper($data['company_data']['ident'], 'UTF-8'), 0, 1, 'L');

		// Inicio Actividades
		$this->SetX(114);
		$this->Cell(36, 3, "Inicio Actividades: " . ' ' . "Agosto 2009", 0, 1, 'L');
