...
@section('header')
	...
	@section('options')
		<div class="actions">
            <a href="{{ url('vadmin/familias/create') }}" class="btn btnSm buttonOther">Nueva</a>
...
@section('custom_js')
	...
	function delete_item(id, route) {	
		...
		var route = "{{ url('vadmin/ajax_delete_familia') }}/"+id+"";
	...
	function batch_delete_item(id) {
		...
		var route = "{{ url('vadmin/ajax_batch_delete_familias') }}/"+id+"";
