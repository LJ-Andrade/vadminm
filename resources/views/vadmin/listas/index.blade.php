...
{{-- HEAD--}}
@section('header')
	@section('header_title', 'Listado de Listas') 
	@section('options')
		<div class="actions">
            <a href="{{ url('vadmin/listas/create') }}" class="btn btnSm buttonOther">Nueva</a>
...
@section('content')
    <div class="container">
		<div class="row">		
			@include('vadmin.listas.searcher')
            <div class="col-md-12 animated fadeIn main-list">
                ...
                <div id="Id{{ $item->id }}" class="Item-Row Select-Row-Trigger row item-row simple-list">
                    ...
                    <div class="List-Actions lists-actions Hidden">
						<a href="{{ url('/vadmin/listas/' . $item->id . '/edit') }}" class="btnSmall buttonOk" data-id="{{ $item->id }}">
