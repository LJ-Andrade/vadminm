...
<a href="{{ url('vadmin/listas') }}"><button type="button" class="btnSmall buttonOk">Mostrar Todos</button></a>
@endif
<div class="row header-options">
    <div class="Search-Filters search-filters">
        ...
        {!! Form::open(['method' => 'GET', 'url' => 'vadmin/listas', 'class' => 'navbar-form', 'role' => 'search']) !!}
            ...
            <a href="{{ url('vadmin/listas') }}"><button type="button" class="btnSmall buttonOk">Todos</button></a>
        {!! Form::close() !!}
        {{-- /Search --}}
