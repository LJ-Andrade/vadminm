...
@section('title', 'Vadmin | Listas')

@section('header')
	@section('header_title', 'Creación de Listas') 
	@section('options')
		<div class="actions">
			<a href="{{ url('vadmin/listas') }}"><button type="button" class="animated fadeIn btnSm buttonOther">Volver</button></a>
		</div>	
	@endsection
@endsection
...
@section('content')
    ...
    <div class="container">
        <div class="small-form container animated fadeIn">
            {!! Form::open(['url' => 'vadmin/listas', 'data-parsley-validate' => '']) !!}
            <div class="row inner">
                <div class="col-md-12 title">
                    <span><i class="ion-plus-round"></i> Creación de Nuevo Item</span>
                    <a href="{{ url('vadmin/listas') }}"><div class="close-btn2"><i class="ion-close-round"></i></div></a>
                </div>
