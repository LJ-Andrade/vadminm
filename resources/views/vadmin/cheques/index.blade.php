...
{{-- PAGE TITLE--}}
@section('title', 'Vadmin | Cheques')

{{-- HEAD--}}
@section('header')
	@section('header_title', 'Listado de Cheques') 
	@section('options')
		<div class="actions">
            <a href="{{ url('vadmin/cheques/create') }}" class="btn btnSm buttonOther">Nueva</a>
...
@section('content')
    <div class="container">
		<div class="row">		
			@include('vadmin.cheques.searcher')
            <div class="col-md-12 animated fadeIn main-list">
                ...
                <div id="Id{{ $item->id }}" class="Item-Row Select-Row-Trigger row item-row simple-list">
                    ...
                    <div class="List-Actions lists-actions Hidden">
						<a href="{{ url('/vadmin/cheques/' . $item->id . '/edit') }}" class="btnSmall buttonOk" data-id="{{ $item->id }}">
							<i class="ion-ios-compose-outline"></i>
						</a>
						<a href="{{ url('vadmin/cheques/'. $item->id) }}" class="btnSmall buttonOther">
