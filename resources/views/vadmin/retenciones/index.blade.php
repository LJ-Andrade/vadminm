...
{{-- PAGE TITLE--}}
@section('title', 'Vadmin | Retenciones')

{{-- HEAD--}}
@section('header')
	@section('header_title', 'Listado de Retenciones') 
	@section('options')
		<div class="actions">
            <a href="{{ url('vadmin/retenciones/create') }}" class="btn btnSm buttonOther">Nueva</a>
...
@section('content')
    <div class="container">
		<div class="row">		
			@include('vadmin.retenciones.searcher')
            <div class="col-md-12 animated fadeIn main-list">
                ...
                <div id="Id{{ $item->id }}" class="Item-Row Select-Row-Trigger row item-row simple-list">
                    ...
                    <div class="List-Actions lists-actions Hidden">
						<a href="{{ url('/vadmin/retenciones/' . $item->id . '/edit') }}" class="btnSmall buttonOk" data-id="{{ $item->id }}">
							<i class="ion-ios-compose-outline"></i>
						</a>
						<a href="{{ url('vadmin/retenciones/'. $item->id) }}" class="btnSmall buttonOther">
