    ...
    <div class="container">
		...
		<div class="row big-card">
			<div class="title">
				...
				<div class="right text-right">Creado el <br> {{ transDateT($reparacion->created_at) }} <br> Autor: {{ $reparacion->user->name }}</div>
			...
			<div class="content">
				<div class="row">
					...
					@if (is_null($reparacion->reparacionesitems) )
					<div class="col-md-12">
...
@section('custom_js')
	...
	function delete_item(id, route) {	
		var route = "{{ url('vadmin/ajax_delete_reparacionesitems') }}/"+id+"";
